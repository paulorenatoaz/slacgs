"""
DEPRECATED: Google Sheets integration is deprecated and will be removed in a future version.
...
warnings.warn(
    "coinfosim.legacy.gspread_client is deprecated and will be removed in a future version. "
...
class GspreadClient:
    ...
    """
		...
		if not new_scenario_ws:
			...
			cost_title = ['coinfosim', 'iters'] + [loss_type for loss_type in loss_types] + [''] + ['n=' + str(2 ** (i + 1)) for
			                                                                                     i in
			                                                                                     range(N_count_reported)] + [
				             ''] + ['dim=' + str(dim) for dim in dims_sim] + ['coinfosim', 'iter'] + [loss_type for loss_type in
			                                                                                     loss_types] + [''] + [
