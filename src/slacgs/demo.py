...
The SCENARIOS list below is still valid for CLI --scenario arguments.
"""
import warnings
import math
import contextlib
...
warnings.warn(
    "The slacgs.demo module is deprecated. Use the CLI interface instead:\n"
    "  - slacgs run-simulation\n"
    "  - slacgs run-experiment\n"
    "  - slacgs make-report\n"
    "  - slacgs config\n"
...
try:
    from slacgs.legacy.gspread_client import GspreadClient
    from slacgs.legacy.gdrive_client import GdriveClient
    from slacgs.utils import report_service_conf, set_report_service_conf, get_grandparent_folder_path
except ImportError:
    # Legacy dependencies not installed - these will be None
    GspreadClient = None
    GdriveClient = None
    report_service_conf = None
    set_report_service_conf = None
    get_grandparent_folder_path = None

# TODO(TASK-090): Remove entire demo module and migrate workflows to CLI
# TODO(TASK-040): Document migration path for existing users
