"""
DEPRECATED: Google Drive integration is deprecated and will be removed in a future version.
...
from slacgs.utils import report_service_conf, set_report_service_conf

warnings.warn(
    "slacgs.legacy.gdrive_client is deprecated and will be removed in a future version. "
